...
{{-- Topbar --}}
<header
    class="sticky top-0 z-10 bg-white/80 backdrop-blur border-b border-zinc-200 dark:bg-zinc-900/80 dark:border-zinc-800">
    <div class="mx-auto max-w-screen-xl px-4 py-3 flex items-center justify-between">
        <a href="{{ url('/') }}" class="flex items-center gap-2 font-semibold">
            <span class="h-4 w-4 rounded-md bg-orange-500"></span>
            <span>{{ config('app.name', 'O Plano') }}</span>
        </a>
            ...
            <nav class="flex items-center gap-2">
                @auth
                    <a href="{{ url('/dashboard') }}"
                       class="inline-flex items-center rounded-md border border-zinc-300 px-4 py-1.5 text-sm hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}"
                       class="inline-flex items-center rounded-md px-4 py-1.5 text-sm hover:underline">
                        Entrar
                    </a>
...
<main class="mx-auto max-w-screen-xl px-4">
    {{-- Hero --}}
    <section class="grid gap-8 py-12 md:grid-cols-2">
        <div class="flex flex-col justify-center">
            <h1 class="text-3xl font-semibold tracking-tight md:text-4xl">
                Gestão Acadêmica com três painéis sob medida
            </h1>
            <p class="mt-3 text-zinc-600 dark:text-zinc-300">
                Admin, Customer Success e Monitor — cada um com suas páginas, ações e métricas.
                Construído com <b>Laravel 12</b>, <b>Livewire 3</b> e <b>Filament 4</b>, com autorização via <b>Spatie
                    Permission</b>.
            </p>

            <div class="mt-6 flex flex-wrap items-center gap-2">
                <span
                    class="rounded-full border border-zinc-300 px-2.5 py-0.5 text-xs dark:border-zinc-700">Laravel 12</span>
                <span
                    class="rounded-full border border-zinc-300 px-2.5 py-0.5 text-xs dark:border-zinc-700">Livewire 3</span>
                <span
                    class="rounded-full border border-zinc-300 px-2.5 py-0.5 text-xs dark:border-zinc-700">Filament 4</span>
                <span class="rounded-full border border-zinc-300 px-2.5 py-0.5 text-xs dark:border-zinc-700">Spatie Permission</span>
                <span class="rounded-full border border-zinc-300 px-2.5 py-0.5 text-xs dark:border-zinc-700">API IBGE + Cache</span>
            </div>

            <div class="mt-6 flex flex-wrap gap-3">
                <a href="#painel"
                   class="inline-flex items-center rounded-md bg-zinc-900 px-5 py-2 text-sm text-white hover:bg-black dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white">
                    Ver funcionalidades
                </a>
                <a href="#acessos"
                   class="inline-flex items-center rounded-md border border-zinc-300 px-5 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800">
                    Acessos rápidos
                </a>
            </div>
        </div>
        ...
        <div id="acessos"
            ...
            <h3 class="text-lg font-semibold">Acesso rápido aos painéis</h3>
            <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-300">Escolha seu ambiente de trabalho:</p>

            <div class="mt-4 grid gap-3 sm:grid-cols-3">
                <a href="{{ url('/admin') }}"
                   class="inline-flex items-center justify-center rounded-md bg-zinc-900 px-4 py-2 text-sm text-white hover:bg-black dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white">/admin</a>
                <a href="{{ url('/cs') }}"
                   class="inline-flex items-center justify-center rounded-md border border-zinc-300 px-4 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800">/cs</a>
                <a href="{{ url('/monitor') }}"
                   class="inline-flex items-center justify-center rounded-md border border-zinc-300 px-4 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800">/monitor</a>
            </div>

            <p class="mt-3 text-xs text-zinc-500 dark:text-zinc-400">
                Use as credenciais de teste (<code>admin@test.com</code>, <code>cs@test.com</code>,
                <code>monitor@test.com</code>)
            </p>
        </div>
    </section>

    {{-- Cards dos painéis --}}
    <section id="painel" class="py-6">
        <h2 class="text-xl font-semibold">O que você encontra em cada painel</h2>
        <div class="mt-4 grid gap-4 md:grid-cols-3">
            <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs text-zinc-500">acesso total</span>
                </div>
                <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
                    CRUD completo de Alunos, Turmas e Matrículas, dashboards macro e gestão no fluxo via Relation
                    Managers.
                </p>
                <a href="{{ url('/admin') }}"
                   class="mt-3 inline-flex text-sm text-zinc-900 underline hover:no-underline dark:text-zinc-100">Entrar
                    no Admin →</a>
            </div>

            <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
                <div class="flex items-center justify-between">
                    <h3 class="font-semibold">Customer Success</h3>
                    <span class="text-xs text-zinc-500">foco operacional</span>
                </div>
                <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
                    Gestão de alunos, pendências e acompanhamento de turmas; exclusões críticas ocultas.
                </p>
                <a href="{{ url('/cs') }}"
                   class="mt-3 inline-flex text-sm text-zinc-900 underline hover:no-underline dark:text-zinc-100">Entrar
                    no CS →</a>
            ...
            <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs text-zinc-500">escopo restrito</span>
                </div>
                <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
                    Acesso às próprias turmas e matrículas atribuídas, com página de visualização das aulas.
                </p>
                <a href="{{ url('/monitor') }}"
                   class="mt-3 inline-flex text-sm text-zinc-900 underline hover:no-underline dark:text-zinc-100">Entrar
                    no Monitor →</a>
    ...
    {{-- Tecnologias --}}
    <section id="tecnologias" class="pb-12">
        <h2 class="text-xl font-semibold">Tecnologias & boas práticas</h2>
        <ul class="mt-3 space-y-2 text-sm text-zinc-600 dark:text-zinc-300">
            <li>Laravel 12 + Livewire 3 + Filament 4</li>
            <li>Spatie Permission (roles: <code>admin_global</code>, <code>customer_success</code>, <code>monitor</code>;
                permissions granulares)
            </li>
            <li>Form dependente Estado→Cidade com API IBGE, cache e fallback</li>
            <li>Elemento Global “Observação Rápida” via Render Hook (com Resource para consulta)</li>
            <li>Policies, validações server-side, índices e prevenção de N+1</li>
        </ul>

        <div class="mt-6 flex flex-wrap gap-3">
            {{--            @guest--}}
            {{--                <a href="{{ route('login') }}"--}}
            {{--                   class="inline-flex items-center rounded-md bg-zinc-900 px-5 py-2 text-sm text-white hover:bg-black dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white">Entrar</a>--}}
            {{--                @if (Route::has('register'))--}}
            {{--                    <a href="{{ route('register') }}"--}}
            {{--                       class="inline-flex items-center rounded-md border border-zinc-300 px-5 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800">Criar--}}
            {{--                        conta</a>--}}
            {{--                @endif--}}
            {{--            @else--}}
            {{--                <a href="{{ url('/dashboard') }}"--}}
            {{--                   class="inline-flex items-center rounded-md bg-zinc-900 px-5 py-2 text-sm text-white hover:bg-black dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white">Ir--}}
            {{--                    para Dashboard</a>--}}
            {{--            @endguest--}}
            <a href="{{ url('/admin') }}"
               class="inline-flex items-center rounded-md border border-zinc-300 px-5 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800">/admin</a>
            <a href="{{ url('/cs') }}"
               class="inline-flex items-center rounded-md border border-zinc-300 px-5 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800">/cs</a>
            <a href="{{ url('/monitor') }}"
               class="inline-flex items-center rounded-md border border-zinc-300 px-5 py-2 text-sm hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800">/monitor</a>
        </div>
    </section>
</main>

{{-- Footer --}}
<footer class="border-t border-zinc-200 py-6 text-sm text-zinc-600 dark:border-zinc-800 dark:text-zinc-400">
    <div class="mx-auto max-w-screen-xl px-4 flex items-center justify-between">
        <span>© {{ now()->year }} {{ config('app.name', 'O Plano') }}</span>
        <span>Construído com Laravel, Livewire, Filament e Spatie.</span>
    </div>
</footer>
</body>
</html>
